...
class MtcnnDetector:
    ...
    def detect_onet(self,im,dets):
        ...
        boxes = boxes[py_nms(boxes, 0.4, "Minimum")]
        keep = py_nms(boxes_c, 0.4, "Minimum")
    ...
    def processed_image(self, img, scale):
        ...
        img_t = ((img_resized-127.5)/128).astype('float32')
        # img = img - (104.0, 117.0, 123.0)
        # img_t = cv2.normalize(img_resized, None, alpha=-1, beta=1, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F)
        return img_t
